...
- 🔴 [Before Reading Dense Material](dense-textbook.md)
- 🔴 [Facing an Impossible Problem Set](impossible-problem-set.md)
- 🔴 [When Everyone Else Seems to Understand](everyone-else-understands.md)
- 🔴 [Learning a New Programming Language](new-programming-language.md)
- 🔴 [Encountering Proofs](proofs-first-time.md)
- 🔴 [Wrestling with Recursion](recursion.md)
- 🔴 [Understanding Pointers and Memory](pointers-and-memory.md)
- 🟡 [Grasping Big-O Notation](big-o-notation.md)
- 🔴 [Making Sense of Functional Programming](functional-programming.md)
